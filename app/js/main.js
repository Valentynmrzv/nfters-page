...
let cardModalData; // Глобальная переменная для хранения данных из card

document.addEventListener('DOMContentLoaded', () => {
  // Загрузите данные из файла card и сохраните их в переменной cardData
  fetch('./nft/content.card')
...
function findUserImages(userName) {
  return cardModalData.filter(item => item.userName === userName);
}
